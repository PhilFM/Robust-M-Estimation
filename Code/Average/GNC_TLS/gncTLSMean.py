...
sigmaLimit = 10.0
numSigmaSteps = 200
gamma = math.exp((math.log(sigmaLimit) - math.log(sigmaBase))/(numSigmaSteps - 1.0))
...
paramInstance = GNC_TLSParams(c, rscale, muBase, muLimit, gamma)
algInstance = GNC_TLSMean(paramInstance, data, weight)
...
plt.legend()
plt.savefig('../../../Output/gncTLSMean.png', bbox_inches='tight')
plt.show()
