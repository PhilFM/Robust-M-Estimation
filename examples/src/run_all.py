...
import misc.integral_rho
import misc.compare_influence
import misc.two_gaussian_limit
import misc.difference_max
import misc.welsch_majorize_check
...
import mean.mean_2d_example
import mean.mean_limit
import mean.trimmed_mean_efficiency
import mean.mean_2d_example
import mean.mean_complexity
import mean.median_dist
import mean.median_breakpoint
...
import mean.mean_nd_complexity
...
import line_fitting.compare_erf_normal
import line_fitting.compare_erf_uv_normal
import line_fitting.line_fit_analyse_breakdown
import line_fitting.line_fit_canonical
import line_fitting.line_fit_examples
import line_fitting.line_fit_test_orthog
import line_fitting.line_welsch_efficiency
import line_fitting.theil_sen_breakdown
...
# multi-dimensional regression examples
sys.path.append("regression")
import regression.regression_efficiency
import regression.regression_complexity_dimension
import regression.regression_complexity_sample_size
...
misc.integral_rho.main(test_run=True, output_folder="../../test_output")
misc.compare_influence.main(test_run=True, output_folder="../../test_output")
misc.two_gaussian_limit.main(test_run=True, output_folder="../../test_output")
misc.difference_max.main(test_run=True, output_folder="../../test_output")
misc.welsch_majorize_check.main(test_run=True, output_folder="../../test_output")
...
mean.mean_2d_example.main(test_run=True, output_folder="../../test_output")
mean.mean_limit.main(test_run=True, output_folder="../../test_output")
mean.trimmed_mean_efficiency.main(test_run=True, output_folder="../../test_output")
mean.mean_2d_example.main(test_run=True, output_folder="../../test_output")
mean.mean_complexity.main(test_run=True, output_folder="../../test_output")
mean.median_dist.main(test_run=True, output_folder="../../test_output")
...
mean.mean_nd_complexity.main(test_run=True, output_folder="../../test_output", quick_run=True)
mean.median_breakpoint.main(test_run=True, output_folder="../../test_output", quick_run=True)
...
line_fitting.compare_erf_normal.main(test_run=True, output_folder="../../test_output")
line_fitting.compare_erf_uv_normal.main(test_run=True, output_folder="../../test_output")
line_fitting.line_fit_analyse_breakdown.main(test_run=True, output_folder="../../test_output")
line_fitting.line_fit_canonical.main(test_run=True, output_folder="../../test_output")
line_fitting.line_fit_examples.main(test_run=True, output_folder="../../test_output")
line_fitting.line_fit_test_orthog.main(test_run=True, output_folder="../../test_output")
line_fitting.line_welsch_efficiency.main(test_run=True, output_folder="../../test_output")
line_fitting.theil_sen_breakdown.main(test_run=True, output_folder="../../test_output")
...
# Multi-dimensional regression examples
regression.regression_efficiency.main(test_run=True, output_folder="../../test_output", quick_run=True)
regression.regression_complexity_dimension.main(test_run=True, output_folder="../../test_output", quick_run=True)
regression.regression_complexity_sample_size.main(test_run=True, output_folder="../../test_output", quick_run=True)
