...
These models are implemented in this folder:
...
- [misc](misc/README.md) Miscellaneous and common code.
- [cython_files](cython_files/README.md) Cython accelerated code supporting fast implementation of the examples.
