...
First we have the code to implement the algorithm of [9] to compute the closed-form solution for rotation and
translation given point clouds `X` and `Y` with a per-point `weight` array:
```
import numpy as np
