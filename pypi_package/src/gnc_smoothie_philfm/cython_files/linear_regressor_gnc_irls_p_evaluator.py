...
class LinearRegressorGNC_IRLSpEvaluator(LinearRegressorEvaluatorBase):
    ...
    def objective_func(self, model: npt.ArrayLike, model_ref, influence_func_instance,
        ...
        return linear_regressor_gnc_irls_p_objective_func(influence_func_instance.p, influence_func_instance.rscale, influence_func_instance.epsilon,
    ...
    def weighted_derivs(self, model: npt.ArrayLike, model_ref, influence_func_instance, lambda_b: float,
        ...
        linear_regressor_gnc_irls_p_weighted_derivs(influence_func_instance.p, influence_func_instance.rscale, influence_func_instance.epsilon,
                                                    lambda_b, model,
    ...
    def update_weights(self, model: npt.ArrayLike, model_ref, influence_func_instance,
        ...
        residual = np.zeros(self._rsize)
        return linear_regressor_gnc_irls_p_update_weights(influence_func_instance.p, influence_func_instance.rscale, influence_func_instance.epsilon,
                                                          model, np.reshape(data[0], (len(data[0]), self._rsize, self._msize)),
